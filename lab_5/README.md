...
1.  Изучить возможности СУБД ClickHouse для ообработки и анализа больших
    данных
...
`ssh user20@62.84.123.211 -i "<путь к ключу>" -L 8787:127.0.0.1:8787`
...
```
    ...
    Installing package into '/home/user20/R/x86_64-pc-linux-gnu-library/4.3'
...
Был проведен анализ сетевой активности с помощью библиотеки
`ClickHouseHTTP` и СУбД `ClickHouse` и были найдены проблемы во
внутренней сети предприятия

## Вывод

В результате выполнения практической работы были получены навыки
использования СУБД `ClickHouse` для обработки и анализа больших данных
